...
def sourceTheoremStatement : TheoremStatement :=
  { sourceKey := sourceRepository,
    ...
    manifoldConstrainedStatement := "polytope-polyhedron combinatorial number theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
...
def ManifoldConstrainedTheoremClosed : Prop :=
  baselineCertificateLane = "polytope_constrained" ∧
